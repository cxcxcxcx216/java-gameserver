...
public class MessageEncoder extends MessageToByteEncoder<ReqProtoMsg> {


    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, ReqProtoMsg msg, ByteBuf out) {
        //获取消息体的长度
